...
description: 完整學習日語敬語基礎，涵蓋です・ます等禮貌語的用法，だ・である等普通語的使用場合，敬語與普通語的區別與轉換，不同場合的敬語選擇，以及實用的敬語練習與對話範例，幫助您掌握日語敬語的正確使用方式。
---
...
1. **名詞句**：使用「だ」結尾（現在肯定）或「である」（書面語、正式文體）
   - 例：私は学生だ / 私は学生である

2. **動詞句**：使用動詞原形（辭書形）
   - 例：本を読む（不是「読みます」）

3. **形容詞句**：形容詞直接結尾，不加「です」
   - 例：今日は暑い（不是「暑いです」）
